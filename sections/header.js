 ...
 <div class="max-w-7xl mx-auto pl-0 pr-5 h-16 flex items-center">
    ...
    <div class="hidden md:flex flex-1 justify-center pr-24">
      <nav class="flex items-center gap-10 text-sm font-semibold text-gray-700">
        ...
        <a href="#home" class="nav-link hover:text-green-700 transition-colors">
          Beranda
        </a>
        
        <a href="#tentang" class="nav-link hover:text-green-700 transition-colors">
          Tentang Kami
        </a>
        
        <a href="#keunggulan" class="nav-link hover:text-green-700 transition-colors">
          Keunggulan
        </a>

        <a href="#layanan" class="nav-link hover:text-green-700 transition-colors">
          Layanan
        </a>


        <a href="#carakirim" class="nav-link hover:text-green-700 transition-colors">
          Cara Kirim
        </a>


        <a href="#kontak" class="nav-link hover:text-green-700 transition-colors">
          Kontak
        </a>
  ...
  <div
    id="mobile-menu"
    class="md:hidden hidden flex-col gap-1 px-5 pb-5 pt-2 bg-white border-t border-gray-100 text-sm font-semibold text-gray-700 shadow-lg"
  >
...
toggle.addEventListener('click', () => {
  ...
  bar1.style.transform = open
    ? ''
    : 'translateY(8px) rotate(45deg)';

  bar2.style.opacity = open
    ? ''
    : '0';
